...
/**
 * Solo User Profile widget class.
 *
 * @since 1.0
 *
 * @package Solo\Widgets
 */
class solo_User_Profile_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'user-profile', __( 'Solo - User Profile', 'genesis' ), $widget_ops, $control_ops );
